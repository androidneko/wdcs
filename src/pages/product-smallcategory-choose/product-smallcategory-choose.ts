...
/**
 * Generated class for the ProductSmallcategoryChoosePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-product-smallcategory-choose',
  templateUrl: 'product-smallcategory-choose.html',
})
export class ProductSmallcategoryChoosePage extends BasePage {
  Category:any={categoryChild:[],customCategoryId:"",merchantId:""};
