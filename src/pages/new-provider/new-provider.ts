...
/**
 * Generated class for the NewProviderPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-new-provider',
  templateUrl: 'new-provider.html',
})
export class NewProviderPage extends BasePage{
  myMerchantId:String="";
  merInfoDummy={merName:"",streamNo:""};
  merContactList:Array<any>=[];
  constructor(public navCtrl: NavController, public navParams: NavParams,private net:TyNetworkServiceProvider,public toastCtrl:ToastController) {
    super(navCtrl,navParams,toastCtrl);
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad NewProviderPage');
  }
  saveBtnCliked(){
    console.log("保存");
